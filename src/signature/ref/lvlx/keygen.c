...
//         // // Modification : rejection sampling when the secret key ideal has reduced norm larger than p
//         // found = found && (ibz_cmp(&sk->secret_ideal.norm, &QUATALG_PINFTY.p) <= 0);
//         // ibz_print(&sk->secret_ideal.norm,10); printf("\n");
