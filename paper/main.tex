...
Recent work~\cite{KLKL25} instantiated SQIsign implementation with fixed-precision integer arithmetic, by deriving uniform worst-case bounds for the quaternion algorithms used in key generation and signing.
